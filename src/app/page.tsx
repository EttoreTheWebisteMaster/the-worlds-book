...
export default function Home() {
	...
	return (
		<Box className={styles.container}>
			...
			<Countdown targetDate='2024-12-31T23:59:59Z' />
			...
			<Paragraph enableFade={false}>
				...
				<div data-aos='fade-up' data-aos-delay="200">
					<Box className={styles.buttonsContainer}>
						<ButtonPrimary
							endIcon={<DrawSharpIcon />}
							className={styles.button}
						>
							Start Writing
						</ButtonPrimary>
						<ButtonSecondary
							endIcon={<LocalLibrarySharpIcon />}
							className={styles.button}
						>
							Read the book
						</ButtonSecondary>
			...
			<Paragraph icon={<AutoStoriesIcon />} iconPosition='right'>
							...
							<>
								...
								<ul className={styles.bulletList}>
									<li>
										...
										costs <b>1WT</b>, encouraging frequent
										contributions without overwhelming users.
									</li>
									<li>
				...
				<div data-aos='fade-up' data-aos-delay="300">
					<TextLong
						...
						description={
							<>
								Missions and rewards on &#34;The World&#39;s Book&#34;
								are designed to <b>keep users engaged and motivated</b>.
								Whether you&#39;re <b>receiving likes</b>, <b>giving support</b> to others,
						...
						details={
							<>
								...
								<ul className={styles.bulletList}>
									...
									<li>
										<b>1000WT</b>: $69.99 – Best for dedicated
					...
					<Text
						value={
							<>
								...
								you&#39;re a <b>seasoned author</b>, a <b>beginner</b>{' '}
								or a <b>troll</b>, your voice matters. Discuss with
								everyone on how the story should <b>transform</b> and{' '}
